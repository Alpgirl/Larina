...
double dens_stand_distrib(double x, double y) {
    double ox = 10.0, oy = 15.0, p = 0.5, mx = 0.0, my = 0.0;
    return 1.0 / (2.0 * M_PI * ox * oy * (1.0 - pow(1.0 - pow(p, 2), 0.5))) * \
...
int main() {
    ...
    points_func(200, dens_stand_distrib, "distr_points.txt", -10.0, step(-10.0, 10.0, 200), 2);
